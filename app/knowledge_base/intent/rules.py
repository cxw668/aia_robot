"""意图规则定义（从 intent_rules 迁移）。"""
from __future__ import annotations

import re

from app.knowledge_base.models.intent import RetrievalIntent, OFFICIAL_BASE_URL
...
INTENT_BONUS_RULES: tuple[tuple[str, tuple[str, ...], int], ...] = (
    ...
    ("product_category", ("变更保险费支付方式", "年付", "月付"), 8),
    ("policy_change", ("年缴改月缴", "年缴改成月缴", "年改月", "年缴", "月缴", "变更保险费支付方式", "保险计划变更"), 10),
)
