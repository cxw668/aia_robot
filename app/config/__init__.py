...
class Settings:
    def __init__(self) -> None:
        ...
        self.auth_login_failure_threshold: int = _to_int(EnvLoader.get("AUTH_LOGIN_FAILURE_THRESHOLD", "5"), 5)
        self.auth_login_failure_window_seconds: int = _to_int(EnvLoader.get("AUTH_LOGIN_FAILURE_WINDOW_SECONDS", "300"), 300)
