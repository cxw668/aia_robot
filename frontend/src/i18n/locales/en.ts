const en = {
  ...
  structuredConfidenceLow: 'Low',
  structuredEvidence: 'Evidence',
  structuredNextActions: 'Next actions',
  structuredRiskTips: 'Risk tips',
  ...
  retryJob: 'Retry job',
  retryJobSuccess: 'Job requeued',
  retryJobError: 'Retry failed, please try again',
