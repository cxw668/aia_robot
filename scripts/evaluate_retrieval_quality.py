...
TEST_CASES: list[TestCase] = [
    TestCase("保险计划变更", "我想把年缴改成月缴，怎么申请？", ["保险计划变更"], ["变更保险费支付方式", "年付", "月付"]),
    TestCase("保单服务", "我的联系方式变了，去哪里改联系电话和地址？", ["保单服务"], ["变更联系资料", "联系电话", "住所信息"]),
    TestCase("保单服务", "变更投保人需要准备什么材料？", ["保单服务"], ["变更投保人", "保险合同内容变更申请书", "有效关系证明文件"]),
    TestCase("合同", "纸质保单丢了，怎么补发保险合同？", ["合同"], ["补发保险合同", "纸质保险合同"]),
    TestCase("合同", "电子保险合同怎么申请或者查看？", ["合同"], ["申请电子保险合同", "电子合同"]),
    TestCase("表单下载", "变更投保人要下载哪份个险表单？", ["表单下载"], ["《保险合同内容变更申请书》", "保险合同内容变更申请书"]),
    TestCase("表单下载", "理赔申请要下载什么个险表单？", ["表单下载"], ["《保险金给付申请书》", "保险金给付申请书"]),
    TestCase("表单下载", "第三方代缴保费需要哪张授权委托书？", ["表单下载"], ["《第三方缴费授权委托书》", "第三方缴费授权委托书"]),
    TestCase("表单下载", "团险续保需要哪份申请书？", ["表单下载"], ["友邦团体保险续保申请书", "续保"]),
    TestCase("分公司", "北京分公司客服电话是多少？", ["分公司"], ["北京", "6528 6938"]),
    TestCase("分公司", "广东分公司地址在哪里？", ["分公司"], ["广东", "沿江西路", "广州"]),
    TestCase("分公司", "安徽分公司信访接待日是什么时候？", ["分公司"], ["安徽", "第四个星期四", "信访接待日"]),
    TestCase("在售产品", "友邦星耀未来年金保险现在在售吗？", ["在售产品"], ["友邦星耀未来年金保险", "在售"]),
    TestCase("在售产品", "有没有友邦增盈宝C款终身寿险（万能型）的产品说明书？", ["在售产品"], ["友邦增盈宝C款终身寿险", "产品说明书"]),
    TestCase("在售产品", "友邦增盈宝C款终身寿险（万能型）属于哪个产品组？", ["在售产品"], ["友邦增盈宝C款终身寿险", "P3"]),
]
