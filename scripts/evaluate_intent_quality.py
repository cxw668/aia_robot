...
TEST_CASES: list[IntentTestCase] = [
    ...
    IntentTestCase("电子保险合同怎么申请或者查看？", "service_guide"),
    IntentTestCase("纸质保单丢了怎么补发保险合同？", "service_guide"),
    ...
    IntentTestCase("友邦增盈宝C款终身寿险（万能型）还在售吗？", "on_sale_product"),
